...
@implementation FXYImageCropManager
/// 裁剪框背景的处理
...
+ (UIImage *)cropImageView:(UIImageView *)imageView toRect:(CGRect)rect zoomScale:(double)zoomScale containerView:(UIView *)containerView {
    ...
    CGFloat xMargin = containerView.fxy_width - CGRectGetMaxX(rect) - rect.origin.x;
    ...
    cropedImage = [[FXYImageManager manager] fixOrientation:cropedImage];
