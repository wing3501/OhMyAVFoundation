...
@implementation FXYImageRequestOperation
...
- (void)start {
    ...
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        [[FXYImageManager manager] getPhotoWithAsset:self.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
